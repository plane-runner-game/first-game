...
| `Weapon_Laser` ("CANNON", crate 6) | damage 1, fireInterval 0.2, Tracer bullets (same range as the Gatling), no pierce, plane `PlaneJet`. Was a piercing Beam until 2026-09-16 ("no laser, bullets") |
