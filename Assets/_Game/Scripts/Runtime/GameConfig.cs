...
namespace SkySquad
{
    ...
    public class GameConfig : ScriptableObject
    {
        ...
        public float diveForward = 8.5f;    // the squad flies this far ahead (z) at altitude 0, 0 at the ceiling: with the camera anchored on the swarm the diving squad stays at ~41% of the screen, above the thumb ("push them forward when I go down", 2026-09-18)
