    ...
    public static class SceneBuilder
    {
        ...
        static Defs CreateDefinitions(Prefabs P)
        {
            ...
            D.config = Asset<GameConfig>("GameConfig", c =>
            {
                ...
                c.endless = true; c.bulletSpeed = 38f; c.enemyBulletSpeed = 28f; c.bulletHitRadius = 0.55f; c.bulletLife = 1.45f; c.bulletSize = 1.6f; c.hordePlanesBase = 120; c.hordePlanesPerHorde = 52;   // horde 2 = 172 (was 220): boss 2 comes ~8 s sooner at 6 planes/s   /* bigger first horde so the faster stream does not bring the boss earlier */
