    ...
    public static class SceneBuilder
    {
        ...
        static Defs CreateDefinitions(Prefabs P)
        {
            ...
            D.config = Asset<GameConfig>("GameConfig", c =>
            {
                ...
                c.enemyStopZ = 12f; c.enemyAltAboveSplit = 1.4f; c.enemyHeightScale = 1.35f; c.enemyFarScale = 1.7f; c.enemyFarScaleZ = 22f; c.altitudeSplit = 4.4f; c.altitudeMax = 5.85f; c.diveForward = 8.5f; /* the diving squad flies up to 8.5 ahead so it stays above the thumb while the camera holds on the swarm */   // the ceiling is the crowd's altitude
