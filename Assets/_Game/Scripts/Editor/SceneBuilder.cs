    ...
    public static class SceneBuilder
    {
        ...
        static Defs CreateDefinitions(Prefabs P)
        {
            ...
            D.config = Asset<GameConfig>("GameConfig", c =>
            {
                ...
                c.upgradeCostFire = 15f; c.upgradeCostDamage = 15f; c.upgradeCostRevenue = 15f; c.upgradeCostGrowth = 2f;   /* 15, 30, 60, 120 ... doubling: level 9 costs 3840, the climb to it 7665 (was x1.6 from 10: 1128 total, "level 9 by attempt 3") */ c.fireRatePerLevel = 0.4f; c.damagePerLevel = 1.0f;   /* "upgrades must strengthen the plane noticeably" (2026-09-16): level 6 now equals the old level 17-18 */ c.revenuePerLevel = 0.1f;   /* 10 coins x 1.10 per revenue level */
